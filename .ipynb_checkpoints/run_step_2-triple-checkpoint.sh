...
INPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/HEIF_IMAGES_265/HEIF_images_triple_largeQP2_265
OUTPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/KL_PLOT_WIDGETS/TRIPLE_largeQP_data

source "/data/lesc/staff/yoshihisa/anaconda3/etc/profile.d/conda.sh"

./2-creating_data.py -t "$TAPPDEC" -i "$INPUT_DIR" -o "$OUTPUT_DIR" run-triple ${SLURM_ARRAY_TASK_ID}
