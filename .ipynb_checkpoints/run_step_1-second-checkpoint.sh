...
INPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/HEIF_IMAGES_LIBHEIF/HEIF_images_second_largeQP2
OUTPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/HEIF_IMAGES_265/HEIF_images_second_largeQP2_265

source "/data/lesc/staff/yoshihisa/anaconda3/etc/profile.d/conda.sh"

./1-perform_encoding.py -heic "$HEIC2HEVC" -i "$INPUT_DIR" -o "$OUTPUT_DIR" run-second ${SLURM_ARRAY_TASK_ID}
