...
#SBATCH --array=0-30799

INPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/HEIF_IMAGES_DATA/HEIF_images_single_recompressed_data
OUTPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/HEIF_IMAGES_CSV/HEIF_images_single_recompressed_csv

source "/data/lesc/staff/yoshihisa/anaconda3/etc/profile.d/conda.sh"

./3-preprocessing_data.py -i "$INPUT_DIR" -o "$OUTPUT_DIR" run-second ${SLURM_ARRAY_TASK_ID}
